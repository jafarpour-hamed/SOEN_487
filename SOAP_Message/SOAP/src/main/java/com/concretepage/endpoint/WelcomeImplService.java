 ...
 * 
 */
@WebServiceClient(name = "WelcomeImplService", targetNamespace = "http://endpoint.concretepage.com/", wsdlLocation = "http://localhost:8080/WebServiceDemo/Welcome?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WELCOMEIMPLSERVICE_QNAME = new QName("http://endpoint.concretepage.com/", "WelcomeImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServiceDemo/Welcome?wsdl");
    ...
    public Welcome getWelcomeImplPort() {
        return super.getPort(new QName("http://endpoint.concretepage.com/", "WelcomeImplPort"), Welcome.class);
    }
    ...
    public Welcome getWelcomeImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.concretepage.com/", "WelcomeImplPort"), Welcome.class, features);
    }
