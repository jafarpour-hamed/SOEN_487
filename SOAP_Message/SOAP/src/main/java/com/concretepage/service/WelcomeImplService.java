 ...
 * 
 */
@WebServiceClient(name = "WelcomeImplService", targetNamespace = "http://service.concretepage.com/", wsdlLocation = "http://localhost:8080/WebServiceDemo/Welcome?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WELCOMEIMPLSERVICE_QNAME = new QName("http://service.concretepage.com/", "WelcomeImplService");
    ...
    public Welcome getWelcomeImplPort() {
        return super.getPort(new QName("http://service.concretepage.com/", "WelcomeImplPort"), Welcome.class);
    }
    ...
    public Welcome getWelcomeImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.concretepage.com/", "WelcomeImplPort"), Welcome.class, features);
    }
